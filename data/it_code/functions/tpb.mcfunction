...
execute as @e[tag=nowb_m,limit=1] at @s if block ~ ~-0.1 ~ minecraft:respawn_anchor if block ~-1 ~-0.1 ~ minecraft:deepslate_tile_stairs if block ~1 ~-0.1 ~ minecraft:deepslate_tile_stairs if block ~ ~-0.1 ~-1 minecraft:deepslate_tile_stairs if block ~ ~-0.1 ~1 minecraft:deepslate_tile_stairs if block ~-1 ~-0.1 ~-1 minecraft:polished_deepslate_wall if block ~1 ~-0.1 ~-1 minecraft:polished_deepslate_wall if block ~-1 ~-0.1 ~1 minecraft:polished_deepslate_wall if block ~1 ~-0.1 ~1 minecraft:polished_deepslate_wall run scoreboard players set testilein tpcooldown 0
...
execute if score testilein tpcooldown matches 1 run execute as @e[tag=nowb_m,limit=1] at @s run summon item ~ ~ ~ {NoGravity:1b,Silent:1b,Item:{id:"minecraft:netherite_ingot",Count:1b}}
execute if score testilein tpcooldown matches 1 run execute as @e[tag=nowb_m,limit=1] at @s run summon item ~ ~ ~ {NoGravity:1b,Silent:1b,Item:{id:"minecraft:amethyst_cluster",Count:3b}}
execute if score testilein tpcooldown matches 1 run execute as @e[tag=nowb_m,limit=1] at @s run summon item ~ ~ ~ {NoGravity:1b,Silent:1b,Item:{id:"minecraft:diamond",Count:2b}}
...
execute as @e[tag=nowb_m,limit=1] at @s align xz positioned ~.5 ~ ~.5 if entity @a[distance=..3.5] if entity @s[scores={tpcooldown=0}] if entity @p[level=5..] run title @a[distance=..3.5] actionbar ["",{"text":"Teleporter is ready","bold":true,"italic":true,"color":"gray"}]
execute as @e[tag=nowb_m,limit=1] at @s align xz positioned ~.5 ~ ~.5 if entity @s[scores={tpcooldown=0}] if entity @p[level=..4] run title @p[distance=..1] actionbar ["",{"text":"Not enough levels","bold":true,"italic":true,"color":"red"}]
execute as @e[tag=nowb_m,limit=1] at @s align xz positioned ~.5 ~ ~.5 if entity @s[scores={tpcooldown=0}] if entity @p[level=5..] run tag @e[distance=..0.5,tag=!punkt_a,tag=!it_name] add tobileinb
execute as @e[tag=nowb_m,limit=1] at @s align xz positioned ~.5 ~ ~.5 if entity @s[scores={tpcooldown=0}] if entity @p[level=5..] if entity @e[tag=!punkt_a,distance=..0.5,tag=!it_name] run scoreboard players operation @e[tag=nowb] tpcooldown = setting tpcooldown
execute as @e[tag=nowb_m,limit=1] at @s align xz positioned ~.5 ~ ~.5 at @e[tag=nowb,limit=1] align xz positioned ~.5 ~ ~.5 if entity @p[level=5..] run tp @e[tag=tobileinb] ~ ~ ~
execute as @e[tag=tobileinb] if entity @p[level=5..] run xp add @s -5 levels
